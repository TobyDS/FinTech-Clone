...
export async function GET(request: Request) {
  ...
  // if (!ids) {
  //   // Return a 400 error with a message saying that id is required
...
const data = {
  '1': {
    ...
    category: 'coin',
    description:
      'Bitcoin (BTC) is a cryptocurrency launched in 2010. Users are able to generate BTC through the process of mining. Bitcoin has a current supply of 19,719,375. The last known price of Bitcoin is 60,141.21953456 USD and is down -4.13 over the last 24 hours. It is currently trading on 11590 active market(s) with $25,755,191,009.89 traded over the last 24 hours. More information can be found at https://bitcoin.org/.',
    slug: 'bitcoin',
