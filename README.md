...
<div style="display: flex; flex-direction: 'row';">
<img src="./screenshots/login_transparent.gif" width=30%>
<img src="./screenshots/state_transparent.gif" width=30%>
<img src="./screenshots/lockscreen_transparent.gif" width=30%>
</div>
<div style="display: flex; flex-direction: 'row';">
<img src="./screenshots/charts_transparent.gif" width=30%>
<img src="./screenshots/icon_transparent.gif" width=30%>
</div>
